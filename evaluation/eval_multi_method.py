...
if __name__ == '__main__':
    ...
    Method_list = ['cddfuse', 'IRFS', 'DATFuse', 'LRRNet', 'KDFuse', 'GIFNet', 'DAFusion', 'SAGE', 'FusionBooster', 'OURS']
    for i, Method in enumerate(Method_list):
        ...
        for _, item in enumerate(eval_bar):
            ...
            # Check if the fusion result file exists
            if not os.path.exists(f_name):
                print(f"Warning: Fusion result file not found: {f_name}. Skipping this file.")
                continue
            ...
            try:
                ...
                print(f"Error: Exception occurred while processing file {item}: {e}. Skipping this file.")
                continue
